...
// Implemented For Testing Purposes
   msg("I am %s thread and my priority is %d",thread_current()->name, thread_current()->priority);
  /* Allocate thread. */
  ...
  if (new_priority < old_priority && list_empty (&t->locks))
    {
      t->priority = new_priority;
       msg("I am %s thread and calling test preempt, my priority is %d",thread_current()->name, thread_current()->priority);
  	thread_test_preemption ();
    }
